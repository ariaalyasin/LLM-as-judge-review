...
\begin{frame}{Table of Contents}
  \begin{enumerate}
    \item \hyperlink{paper1}{\textbf{Cheating Automatic LLM Benchmarks: Null Models Achieve High Win Rates}}
    \item \hyperlink{paper6}{\textbf{Humans or LLMs as the Judge? A Study on Judgement Bias}}
